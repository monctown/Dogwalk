...
(function() {
    ...
    // Message element for displaying success/failure messages
    $message = document.createElement('span');
    $message.classList.add('message');
    $form.appendChild($message);

    // Display the success message (after form submission)
    $form.addEventListener('submit', function() {  // Removed 'event' as it's not being used
        // Show success message after submission (you can change this to handle server responses later)
